...
import uk.gov.di.mobile.wallet.cri.credential.CredentialServiceException;
...
public class CredentialPervice {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(CredentialPervice.class);

    public CredentialPervice(
    ...
    public void getCredential(SignedJWT accessToken, SignedJWT proofJwt)
