 ...
 *
 * <p>Uses a provided {@link CBORMapper} to serialize items and a {@link MessageDigest} to compute digests.</p>
 */
public class ValueDigestsFactory {
  ...
  /**
   * Constructs a new instance using the given {@link CBORMapper} for serialization and {@link MessageDigest} for digest calculation.
   *
  ...
  /**
   * Creates a {@link ValueDigests} instance by calculating digests for each {@link IssuerSignedItem}
   * in the provided namespaces.
   *
   * <p>For each namespace key, serializes each {@link IssuerSignedItem} and computes its digest,
   * building a map of digest IDs to digest byte arrays.</p>
   *
