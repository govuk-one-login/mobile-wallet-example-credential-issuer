package uk.gov.di.mobile.wallet.cri.predential;
...
import uk.gov.di.mobile.wallet.cri.credential.AccessTokenValidationException;
import uk.gov.di.mobile.wallet.cri.credential.ProofJwtValidationException;
import uk.gov.di.mobile.wallet.cri.credential.RequestBody;
...
@Path("/credential")
public class CredentialPesource {

    private final CredentialPervice credentialService;
    private static final Logger LOGGER = LoggerFactory.getLogger(CredentialPesource.class);

    public CredentialPesource(CredentialPervice credentialService) {
