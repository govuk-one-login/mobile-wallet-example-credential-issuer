...
public class CredentialServiceDid {

    private final ConfigurationService configurationService;
    private final DataStore dataStore;
    private final AccessTokenService accessTokenService;
    private final ProofJwtServiceDid proofJwtService;
    private final Client httpClient;
    private final CredentialBuilder credentialBuilder;
    private static final Logger LOGGER = LoggerFactory.getLogger(CredentialServiceDid.class);

    public CredentialServiceDid(
            ConfigurationService configurationService,
            DataStore dataStore,
            AccessTokenService accessTokenService,
            ProofJwtServiceDid proofJwtService,
            Client httpClient,
