...
public class MDLDocumentFactory {
    ...
    public MDLDocumentFactory(IssuerSignedItemFactory issuerSignedItemFactory) {
        this.issuerSignedItemFactory = issuerSignedItemFactory;
    }

    public MDLDocument build(final DrivingLicenceDocument drivingLicence) {
        ...
        return new MDLDocument(MOBILE_DRIVING_LICENCE_DOCUMENT_TYPE, issuerSigned);
    }
