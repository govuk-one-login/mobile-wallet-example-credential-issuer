...
public class NamespaceBuilder {
  ...
  public NamespaceBuilder(IssuerSignedItemFactory issuerSignedItemFactory, CBOREncoder cborEncoder) {
  ...
  public Map<String, List<byte[]>> buildNamespace(Object input, String namespace)
          throws MDLException {
    ...
    return Map.of(namespace, issuerSignedItems);
  }
