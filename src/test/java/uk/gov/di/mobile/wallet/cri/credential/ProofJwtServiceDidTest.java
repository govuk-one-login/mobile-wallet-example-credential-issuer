...
class ProofJwtServiceDidTest {

    private ProofJwtServiceDid proofJwtService;

    @BeforeEach
    void setup() {
        proofJwtService = new ProofJwtServiceDid();
    }
    ...
    void shouldThrowProofJwtValidationExceptionWhenSignatureVerificationFailed()
        ...
        SignedJWT signedJwt =
                getTestProofJwt(
                        "did:key:zDnaewZMz7MN6xSaAFADkDZJzMLbGSV25uKHAeXaxnPCwZomX", // MUST BE UPDATED
                        "urn:fdc:gov:uk:wallet",
                        "urn:fdc:gov:uk:example-credential-issuer");
