...
public class ArnUtilTest {
    ...
    @Test
    public void Should_ReturnCaId_When_ArnIsValid() {
        String arn =
    ...
    @Test
    public void Should_ThrowException_When_ArnIsMissingId() {
    ...
    @Test
    public void Should_ThrowException_When_ArnIsMalformed() {
    ...
    @Test
    public void Should_ReturnKeyId_When_KmsArnIsValid() {
    ...
    @Test
    public void Should_ThrowException_When_KmsArnIsInvalid() {
        String arn = "not-a-valid-arn";
