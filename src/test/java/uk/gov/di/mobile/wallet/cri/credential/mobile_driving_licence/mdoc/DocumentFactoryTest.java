...
//
//    /**
//     * Test that the DocumentFactory creates both ISO and UK namespaces, and that the correct
// number
...
//        assertEquals(3, namespaces.get(Namespaces.UK).size(), "UK namespace should have 3
// fields");
//    }
//
//    /**
...
//        Document result = documentFactory.build(drivingLicenceDocument);
//
//        // Assert: Check that UK namespace has correct number of fields and that each field has
// been
//        // CBOR encoded
...
//                2,
//                ukNamespace.size(),
//                "Should not create an IssuerSignedItem for provisional driving privileges when its
// value is null");
...
//                new IssuerSignedItem(1, new byte[] {1, 2, 3}, "elementIdentifier",
// "elementValue");
...
//
//        // Arrange: Set up CBOR encoding for both the IssuerSignedItem and the
...
//                                        item,
//                                        "All UK namespace items should match the expected
// CBOR-encoded IssuerSignedItem"));
//        encodedNamespaces
//                .get(Namespaces.ISO)
//                .forEach(
//                        item ->
...
//                                        expectIssuerSignedItemCbor,
//                                        item,
//                                        "All ISO namespace items should match the expected
// CBOR-encoded IssuerSignedItem"));
//
