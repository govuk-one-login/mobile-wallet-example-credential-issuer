...
public class PreAuthorizedCodeBuilderTest {
    ...
    void testItReturnsSignedJwt() throws JOSEException, SigningException, ParseException {
        ...
        SignedJWT preAuthorizedCode = preAuthorizedCodeBuilder.buildPreAuthorizedCode("1234");
        assertThat(
