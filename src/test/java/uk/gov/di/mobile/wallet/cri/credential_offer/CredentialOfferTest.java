...
class CredentialOfferTest {
    ...
    void Should_CreateCredentialOffer() {
        ...
        Map<String, Map<String, String>> grants = Map.of(
        ...
        assertArrayEquals(new String[]{credentialType}, credentialOffer.getCredentialConfigurationIds());
    ...
    void Should_SerializeCredentialIssuerWithCorrectPropertyName() throws Exception {
        ...
        assertEquals("https://credential-issuer.example.com", jsonNode.get("credential_issuer").asText());
    }
    ...
    void Should_SerializeCrdentialConfigurationIdsWithCorrectPropertyName() throws Exception {
        ...
        assertEquals("TestCredentialType", jsonNode.get("credential_configuration_ids").get(0).asText());
    }
}
