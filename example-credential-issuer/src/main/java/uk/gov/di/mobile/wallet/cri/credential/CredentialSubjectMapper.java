...
import uk.gov.di.mobile.wallet.cri.credential.jwt.digital_veteran_card.domain.VeteranCard;
import uk.gov.di.mobile.wallet.cri.credential.jwt.digital_veteran_card.VeteranCardCredentialSubject;
import uk.gov.di.mobile.wallet.cri.credential.jwt.digital_veteran_card.VeteranCardCredentialSubjectBuilder;
...
import uk.gov.di.mobile.wallet.cri.credential.jwt.domain.NamePart;
import uk.gov.di.mobile.wallet.cri.credential.jwt.social_security_credential.SocialSecurityCredentialSubject;
import uk.gov.di.mobile.wallet.cri.credential.jwt.social_security_credential.SocialSecurityCredentialSubjectBuilder;
import uk.gov.di.mobile.wallet.cri.credential.jwt.social_security_credential.domain.SocialSecurityDocument;
import uk.gov.di.mobile.wallet.cri.credential.jwt.social_security_credential.domain.SocialSecurityRecord;
