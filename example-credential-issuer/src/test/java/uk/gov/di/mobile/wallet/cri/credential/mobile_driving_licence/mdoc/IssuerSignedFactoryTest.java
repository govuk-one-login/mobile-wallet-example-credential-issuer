...
import uk.gov.di.mobile.wallet.cri.credential.mdoc.mobile_driving_licence.mdoc.IssuerSignedFactory;
...
class IssuerSignedFactoryTest {
    ...
    void Should_ReturnIssuerSigned_When_ValidNamespacesProvided()
        ...
        // Act
        IssuerSigned result = issuerSignedFactory.build(mockNamespaces, mockEcPublicKey);
