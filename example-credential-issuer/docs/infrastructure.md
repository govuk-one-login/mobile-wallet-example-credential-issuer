...
```
Note: before an instance of the Example Credential Issuer can be deployed both stacks Platform CA, and Document Signing Certificate Issuer (DSC), need to be deployed into the same environment.
