...
import { validateVeteranCardForm } from "./helpers/validation";
...
export function veteranCardDocumentBuilderPostController({
  ...
  return async function (req: Request, res: Response): Promise<void> {
    try {
      ...
      const errors = validateVeteranCardForm(body);
      ...
      await saveDocument(getDocumentsTableName(), {
        ...
        credentialTtlSeconds: calculateCredentialTtlSeconds(body),
